...
class Queue
{
    ...
    public function pushAction()
    {
        ...
        $this->hub->publish(new CoffeePotProgressMessage($task->getId(), CoffeePotProgressMessage::STAGE_PENDING, (new \DateTime())->getTimestamp()));
        ...
        $this->hub->publish(new CoffeePotProgressMessage($task->getId(), CoffeePotProgressMessage::STAGE_FAILED), (new \DateTime())->getTimestamp());
